...
(function () {
   ...
   */
  var InlineLexer, Lexer, Parser, Renderer, TextRenderer, baseUrls, block, edit, escape, inline, marked, noop, originIndependentUrl, resolveUrl, splitCells, unescape;
  ...
  Lexer = function () {
    class Lexer {
      ...
      token(src, top) {
        var align, b, base1, base2, bull, cap, cells, checkbox, checked, header, i, is_ordered, item, k, keys, l, len, len1, loose, mode, next, o, p, ref, ref1, ref2, ref3, space, tag, trim, type;
        while (src) {
          // newline
          ...
          if (cap = this.rules.abbr.exec(src)) {
            ...
            keys = Object.keys(this.tokens.abbrs).join("|");
            this.tokens.abbrs_reg = `(${keys})`;
            continue;
          }
          // def
  ...
  InlineLexer = function () {
    class InlineLexer {
      ...
      output(src) {
        var cap, href, k, len, link, mark, method, num, o, out, ref, ref1, s, text, title;
        out = [];
        while (src) {
          // escape
          ...
          if (cap = this.rules.tag.exec(src)) {
            ...
            src = src.slice(cap[0].length);
            out.push(this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(cap[0]) : cap[0] : cap[0]);
            continue;
          }
          // link
          ...
          if (cap = this.rules.note.exec(src)) {
            ...
            out.push(this.renderer.note(num, text));
            continue;
          }
          // br
          ...
          // kbd, strong
          if ((cap = this.rules.kbd.exec(src)) || (cap = this.rules.center.exec(src)) || (cap = this.rules.strong.exec(src))) {
            ...
            out.push(this.renderer[method](this.output(cap[2])));
            continue;
          }
          // em
          if (cap = this.rules.em.exec(src)) {
            // console.log 'em', cap
            src = src.slice(cap[0].length);
            out.push(this.renderer.em(this.output(cap[6] || cap[5] || cap[4] || cap[3] || cap[2] || cap[1], cap[0][0])));
            continue;
          }
          // sup
          if (cap = this.rules.sup.exec(src)) {
            // console.log 'sup', cap
            src = src.slice(cap[0].length);
            out.push(this.renderer.sup(this.output(cap[1])));
            continue;
          }
          // sub
          if (cap = this.rules.sub.exec(src)) {
            // console.log 'sub', cap
            src = src.slice(cap[0].length);
            out.push(this.renderer.sub(this.output(cap[1])));
            continue;
          }
          // code
          ...
          if (cap = this.rules.text.exec(src)) {
            ...
            if (this.abbrs_reg) {
              ...
              for (k = 0, len = ref1.length; k < len; k++) {
                ...
                o = this.links[s];
                if (o) {
                  out.push(this.renderer.abbr(s, o.title));
                } else {
                  out.push(this.renderer.text(s));
                }
              }
            } else {
  ...
  Renderer = class Renderer {
    ...
    note(num, title) {
      var text;
      if (typeof text !== "undefined" && text !== null ? text.join : void 0) {
        text = text.join("");
      }
  ...
  TextRenderer = function () {
    ...
    TextRenderer.prototype.url = f_nop;
  ...
  Parser = class Parser {
    ...
    parse(src) {
      var k, len, m, notes, out, ref, tag, text;
      ({ m } = this.options);
     ...
     */
    tok() {
      var _row, body, cell, checked, flags, header, html, i, j, k, len, len1, len2, mode, o, ordered, p, q, ref, ref1, row, start, taskList, tasklist;
      switch (this.token.type) {
        ...
        case 'heading':
          return this.renderer.heading(this.inline.output(this.token.text), this.token.depth, this.inlineText.output(this.token.text).join(""));
        case 'container':
          return this.renderer.container(this.token.text, this.token.lang);
        case 'code':
        ...
        case 'table':
          ...
          for (i = k = 0, len = ref.length; k < len; i = ++k) {
            ...
            cell.push(this.renderer.tablecell(this.inline.output(o), {
              header: true,
              align: this.token.align[i]
            }));
          }
          ...
          for (i = p = 0, len1 = ref1.length; p < len1; i = ++p) {
            row = ref1[i];
            cell = [];
            for (j = q = 0, len2 = row.length; q < len2; j = ++q) {
              _row = row[j];
              cell.push(this.renderer.tablecell(this.inline.output(_row), {
                header: false,
