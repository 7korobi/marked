...
(function () {
  // Helpers
  var InlineLexer, Lexer, Parser, Renderer, block, escape, inline, marked, noop, replace, slugo, unescape;
  ...
  Renderer = class Renderer {
    ...
    heading(text, level, raw) {
      var id;
      id = this.options.headerPrefix + slugo(raw);
