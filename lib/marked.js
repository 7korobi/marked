...
(function () {
  ...
  Lexer = function () {
    class Lexer {
      ...
      token(src, top) {
        var align, b, base1, bull, cap, cells, checkbox, checked, header, i, is_ordered, item, k, l, len, len1, loose, next, o, p, ref, ref1, ref2, ref3, space, tag, trim, type;
        while (src) {
          // newline
  ...
  Parser = class Parser {
     ...
     */
    tok() {
      var _row, body, cell, checked, flags, header, html, i, j, k, len, len1, len2, o, ordered, p, q, ref, ref1, row, start, taskList, tasklist;
      switch (this.token.type) {
        ...
        case 'heading':
          return this.renderer.heading(this.inline.output(this.token.text), this.token.depth, unescape(this.inlineText.output(this.token.text).join("")));
        case 'code':
